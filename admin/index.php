               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-6">
                        ...
                        <div class="small-box bg-info">
                           <div class="inner">
                              <h3><i class="nav-icon far fa-image"></i></h3>
                              <p>Gallery</p>
                           </div>
                           <div class="icon">
                     ...
                     <div class="col-md-4 col-sm-6">
                        ...
                        <div class="small-box bg-success">
                           <div class="inner">
                              <h3><i class="nav-icon fas fa-upload"></i></h3>
                              <p>Upload</p>
                           </div>
                           <div class="icon">
                     ...
                     <div class="col-md-4 col-sm-6">
                        ...
                        <div class="small-box bg-warning">
                           <div class="inner">
                              <h3><i class="ion ion-person-add" style="color: white;"></i></h3>
                              <p style="color: white;">Courses</p>
                           </div>
                           <div class="icon">
                              <i class="ion ion-person-add"></i>
                           </div>
                           <a href="view_course.php" class="small-box-footer" style="color: white !important;">More info <i class="fas fa-arrow-circle-right" style="color: white;"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <!-- ./col -->
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-6">
                        ...
                        <div class="small-box bg-success">
                           <div class="inner">
                              <h3><i class="nav-icon fas fa-sign-out-alt"></i></h3>
                              <p>Logout</p>
                           </div>
                           <div class="icon">
