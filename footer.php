<!-- Start Footer -->  
        <footer class="footer" style="background:#8cba8c;"> 
            <!-- Start Footer Top -->
            <div class="container">
                <div class="row row1">
                    <div class="col-sm-12 clearfix">
                        ...
                        <div class="col-md-3 col-sm-4" style="min-height: 230px;">
                                <aside>
                                    <h3 style="font-size:20px; color:#006b1c;">Important Links</h3>
                                    <ul class="list-links" style="margin-right:50px;text-align: center;">
                        ...
                        <div class="col-sm-4">
                           <h3 style="font-size:20px; color:#006b1c;"> Reach us </h3>
                           ...
                           <div class="con-info clearfix">
                            ...
                            <ul class="teachers-follow">
                                    ...
                                    <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true" style="color:#ffffff!important;"></i></a></li>
                                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true" style="color:#ffffff!important;"></i></a></li>
                            </ul>
            ...
            <!-- End Footer Top --> 
            <!-- Start Footer Bottom -->
            <div class="bottom" style="background:#006b1c;">
                <div class="container">
                    <div class="row">
...
<!-- Mirrored from protechtheme.com/edumart/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 06:17:10 GMT -->
</html>