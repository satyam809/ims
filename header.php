...
<!-- Mirrored from protechtheme.com/edumart/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 06:14:01 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <title>CONCEPT ASB CLASSES</title>
        <!-- Reset CSS -->
    ...
    <body>
        ...
        <header> 
            ...
            <div class="container header-middle" >
                <div class="row"> <span class="col-xs-6 col-sm-3"><a href="index.php"><img src="images/logo.jpg" class="img-responsive" alt="" style="width:40%;"></a></span>
